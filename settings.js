...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=SZ8EFCjZ#I3-dk0ePHhMy9OrzPtTBGGbhHkaBHU692-yIbIqP3JQ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '4536': process.env.MAX_SIZE,/*add this in megabytes*/    
